class RegisterTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @register_type.save
        @register_types = RegisterType.all
        format.html { redirect_to @register_type, notice: 'Registry type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @register_type.update(register_type_params)
        @register_types = RegisterType.all
        format.html { redirect_to @register_type, notice: 'Registry type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to register_types_url, notice: 'Registry type was successfully destroyed.' }
  ...
  private
    ...
    def register_type_params
      params.require(:register_type).permit(:name, :description)
    end
end
