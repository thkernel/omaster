...
class LocalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post localities_url, params: { locality: { city_id: @locality.city_id, name: @locality.name, status: @locality.status } }
    end
  ...
  test "should update locality" do
    patch locality_url(@locality), params: { locality: { city_id: @locality.city_id, name: @locality.name, status: @locality.status } }
